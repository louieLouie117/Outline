  ...
  return (
    <div className="Hero-Container">
      ...
      <header>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="165" height="47" viewBox="0 0 165 47"><g transform="translate(-122 -274)"><text transform="translate(172 312)" font-size="41" font-family="MS-UIGothic, MS UI Gothic"><tspan x="0" y="0">outline</tspan></text><rect width="48" height="47" rx="6" transform="translate(122 274)" fill="#136dc0"/><g transform="translate(-2.917 -2.718)"><line x2="24.015" transform="translate(136.917 294.567)" fill="none" stroke="#fff" stroke-width="1.5"/><line x2="24.015" transform="translate(136.917 300.218)" fill="none" stroke="#fff" stroke-width="1.5"/><line x2="24.015" transform="translate(136.917 305.868)" fill="none" stroke="#fff" stroke-width="1.5"/><line x2="24.015" transform="translate(136.917 311.519)" fill="none" stroke="#fff" stroke-width="1.5"/><path d="M0,0H11.3" transform="translate(136.917 288.917)" fill="none" stroke="#fff" stroke-width="1.5"/></g></g></svg>
